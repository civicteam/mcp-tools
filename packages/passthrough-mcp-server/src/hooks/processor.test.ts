...
import { processRequestThroughHooks, processResponseThroughHooks } from './processor.js';
...
describe('Hook Processor', () => {
  describe('processRequestThroughHooks', () => {
    ...
    it('should process request through single approving hook', async () => {
      ...
      const result = await processRequestThroughHooks(toolCall, [mockHook as any]);
    ...
    it('should stop processing on first rejection', async () => {
      ...
      const result = await processRequestThroughHooks(toolCall, [hook1, hook2, hook3] as any);
    ...
    it('should allow hooks to modify tool call', async () => {
      ...
      const result = await processRequestThroughHooks(originalToolCall, [mockHook as any]);
  ...
  describe('processResponseThroughHooks', () => {
    it('should process response through hooks in reverse order', async () => {
      ...
      await processResponseThroughHooks(response, toolCall, hooks as any, 2);
    ...
    it('should handle response rejection', async () => {
      ...
      const result = await processResponseThroughHooks(response, toolCall, [mockHook] as any, 0);
    ...
    it('should allow hooks to modify response', async () => {
      ...
      const result = await processResponseThroughHooks(originalResponse, toolCall, [mockHook] as any, 0);
